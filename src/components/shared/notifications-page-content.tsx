...
/**
 * Shared notifications page content component.
 *
 * Used by roles that don't have a dedicated notifications page
 * (super-admin, university-admin, department-coordinator, program-coordinator,
 * external-evaluator). Renders the same notification list as the student
 * notifications page, fetching from the global /api/notifications/inbox
 * endpoint which is user-scoped via RLS.
 */
export function NotificationsPageContent() {
  ...
  }, [page, filterUnread, fetchNotifications]);
