...
export default function SiteSupervisorSettingsPage() {
          ...
          <CardContent className="space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="space-y-2">
                <Label htmlFor="ss-fullname" className="flex items-center gap-1.5">
              ...
              <div className="space-y-2">
                <Label htmlFor="ss-phone" className="flex items-center gap-1.5">
            ...
            <div className="space-y-2">
              <Label htmlFor="ss-email" className="flex items-center gap-1.5">
